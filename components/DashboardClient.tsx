      ...
      <div className="mx-auto space-y-8">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">
            Overview of your store performance and product analytics (10 random
            products)
          </p>
        </div>
        ...
        <Card className="border-l-4 border-l-zinc-200">
          <CardHeader>
          ...
          <CardContent>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b text-muted-foreground hover:bg-slate-50">
                ...
                <tbody>
                  {selectedProducts.map((p, index) => {
                    const product = selectedProducts.find(
                      (prod) =>
                        prod.name === p.name.replace("…", "") ||
                        prod.name.startsWith(p.name.replace("…", "")),
                    )!;
                    return (
                      <tr
                        key={index}
